			...
			<table class="table table-bordered"  id="offertable"  class="tablesorter" > 
					...
					<tbody>
						...
						<tr><td   ><img  class="img1" src='http://achievecraft.com/tools/avatar/32/{{item.playerName}}.png' alt='{{item.playerName}}'>{{item.playerName}}</td>
							...
							<td>{{ item.priceAll }} </td>
							<td class='to_right'>
								<button class='btn btn-primary'>Zrušit</button>
							</td>
						</tr>
						{% endfor %}
					</tbody>
						...
						<tr><td   ><img  class="img1" src='http://achievecraft.com/tools/avatar/32/{{item.playerName}}.png' alt='{{item.playerName}}'>{{item.playerName}}</td>
							...
							<td class='to_right'>
								<span class="input-prepend input-append">
									...
									<input class="span2 input1 items_count" id="appendedPrependedInput" type="text" placeholder='Počet'>
								</span>
